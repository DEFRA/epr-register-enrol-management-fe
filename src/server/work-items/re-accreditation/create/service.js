    ...
    async create({ formValues, user }) {
      ...
      if (result.ok) {
        return {
          ...
          // RA-219: the reference is generated by the backend and returned
          // on the created work item's payload — never generated here.
          applicationReference: result.workItem?.payload?.applicationReference
        }
      }
